...
<c:url var="addUrl" value="/home/login/center" />

<c:url var="addSearch" value="/home/login/center/search" />
		...
		<div class="card shadow">
			<div class="card-body">
				<h5 class="card-title text-center">
					<i class="fa fa-hospitals"></i><br>View Centers
				</h5>
				<sf:form method="post"
						...
						<tbody>
							<c:forEach items="${list}" var="c" varStatus="centers">
								<tr>
									...
									<c:if test="${sessionScope.user.roleId == 1}">
								<td><a class="text-dark" href="${editUrl} ${c.id}"
